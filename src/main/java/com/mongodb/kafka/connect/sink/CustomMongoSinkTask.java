...
public class CustomMongoSinkTask extends SinkTask {
  static final Logger LOGGER = LoggerFactory.getLogger(CustomMongoSinkTask.class);
  private static final String CONNECTOR_TYPE = "sink";
  private CustomStartedMongoSinkTask startedTask;
  ...
  public void start(final Map<String, String> props) {
    ...
    try {
      ...
      startedTask = new CustomStartedMongoSinkTask(sinkConfig, client, createErrorReporter());
