...
public final class CustomWriteModelStrategyHelper {

  public static List<WriteModel<BsonDocument>> createWriteModel(
  ...
  static List<WriteModel<BsonDocument>> createValueWriteModel(
      final MongoSinkTopicConfig config, final SinkDocument sinkDocument) {
    try {
      return config.getCustomWriteModelStrategy().createWriteModel(sinkDocument);
    } catch (Exception e) {
  ...
  private CustomWriteModelStrategyHelper() {}
}
